import { Component, Renderer2, ElementRef, forwardRef, Optional, Inject } from '@angular/core';
...
@Component({
  selector: 'app-widget11',
  templateUrl: './widget11.component.html',
  styleUrls: ['./widget11.component.css'],
})
export class Widget11Component extends BaseWidgetComponent {
  constructor(
  ...
  override;
  retry() {
    console.log('retry from widget 11');
  }
}
